...
ControlMain::ControlMain(){
    ...
    //解析后封装成CAN协议转发至22004
    server_info_t *modbus_srv = (server_info_t *)malloc(sizeof(server_info_t));
...
log_debug("modbus_srv:%p",modbus_srv);
    ...
    server_info_t *xly_srv = (server_info_t *)malloc(sizeof(server_info_t));
...
//    start_tcp_client_th(conf->canOpenIp.toLatin1().data(),conf->canOpenPort,&xlySocket);
//    //CanOpen 客户端连接
